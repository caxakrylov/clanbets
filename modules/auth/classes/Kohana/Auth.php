...
abstract class Kohana_Auth {
	...
	abstract protected function _login_email($email, $password, $remember);	
	...
	public function login_email($email, $password, $remember = FALSE)
	{
		if (empty($password))
			return FALSE;

		return $this->_login_email($email, $password, $remember);
	}
